...
import org.example.gourmetbot.tools.ReservationTools
...
class ReservationAgent(
    ...
    private val reservationTools: ReservationTools,
    ...
    fun process(userMessage: String, conversationId: String): String? {
        ...
        val systemPrompt = SystemPromptTemplate(workerPrompts["reservation"])
        ...
        return chatClient.prompt()
            ...
            .tools(reservationTools, sommelierTools)
            .call()
            .content()
    }
}